...
$exchange = "bitcurex_eur";

// get the relevant address
$q = db()->prepare("SELECT * FROM accounts_bitcurex_eur WHERE user_id=? AND id=?");
...
function bitcurex_eur_query($key, $secret, $path, array $req = array()) {
...
$info = bitcurex_eur_query($account['api_key'], $account['api_secret'], 'https://eur.bitcurex.com/api/0/getFunds');
...
foreach (array('eur', 'btc') as $currency) {
