...
/**
 * Hobonickels Search job.
 * The Hobonickels Search (through Abe) does not provide an expressive enough API
...
$abe_data = array(
	'currency' => 'hbn',
	'block_table' => 'hobonickels_blocks',
	'block_job' => 'hobonickels_block',
	'explorer_url' => get_site_config('hbn_address_url'),
	'confirmations' => get_site_config('hbn_confirmations'),
);
