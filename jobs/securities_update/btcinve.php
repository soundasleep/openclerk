...
/**
 * A batch script to get all current BTCInve securities and queue them up for ticker values,
 * so we will have historical data even if no user has the security yet.
 */

$exchange = "securities_btcinve";
$currency = 'btc';

// get the API data
$json = crypto_json_decode(crypto_get_contents(crypto_wrap_url('https://www.btcinve.com/api/ticker')));
