...
/**
 * Terracoin Search job (FTC).
 * The Terracoin Search (through Abe) does not provide an expressive enough API
...
$abe_data = array(
	...
	'block_job' => 'terracoin_block',
	'explorer_url' => get_site_config('trc_address_url'),
	'confirmations' => get_site_config('trc_confirmations'),
);
