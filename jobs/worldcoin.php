...
/**
 * Worldcoin Search job (FTC).
 * The Worldcoin Search (through Abe) does not provide an expressive enough API
...
$abe_data = array(
	...
	'block_job' => 'worldcoin_block',
	'explorer_url' => get_site_config('wdc_address_url'),
	'confirmations' => get_site_config('wdc_confirmations'),
);
