...
/**
 * Dogecoin Search job (FTC).
 * The Dogecoin Search (through Abe) does not provide an expressive enough API
...
$abe_data = array(
	'currency' => 'dog',
	'block_table' => 'dogecoin_blocks',
	'block_job' => 'dogecoin_block',
	'explorer_url' => get_site_config('dog_address_url'),
	'confirmations' => get_site_config('dog_confirmations'),
);
