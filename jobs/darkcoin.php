...
/**
 * Darkcoin Search job.
 * The Darkcoin Search (through Abe) does not provide an expressive enough API
...
$abe_data = array(
	'currency' => 'drk',
	'block_table' => 'darkcoin_blocks',
	'block_job' => 'darkcoin_block',
	'explorer_url' => get_site_config('drk_address_url'),
	'confirmations' => get_site_config('drk_confirmations'),
);
