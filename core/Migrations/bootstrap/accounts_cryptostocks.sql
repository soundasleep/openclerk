...
CREATE TABLE `accounts_cryptostocks` (
  ...
  `api_email` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `api_key_coin` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `api_key_share` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
