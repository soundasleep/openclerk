...
/**
 * de template file
 * Generated from 'for_use_openclerk_templatejson_de.json' at Wed, 28 May 2014 19:59:14 +1200
 */
...
$result = array(
	...
	"Add Accounts and Addresses" => "Konten und Adressen hinzufügen ",
	"Add Addresses" => "Adressen hinzufügen",
	"Add All Graphs" => "Alle Graphen hinzufügen ",
	"Add Category" => "Kategorie hinzufügen",
	"Add Exchanges" => "Handelsplatz hinzufügen",
	"Add Graph" => "Grafik hinzufügen",
	"Add Individual Securities" => "Einzelne Wertpapiere hinzufügen",
	"Add Mining Pools" => "Mining Pools hinzufügen",
	"Add New Notification" => "Neue Benachrichtigung hinzufügen",
	"Add OpenID Identity" => "OpenID-Identität hinzufügen",
	"Add Other Account" => "Weiteres Konto hinzufügen",
	"Add Page" => "Seite hinzufügen",
	"Add Securities Exchanges" => "Wertpapierhandelsplätze hinzufügen",
	...
	"Add addresses" => "Adressen hinzufügen",
	"Add another OpenID Identity" => "Eine weitere OpenID-Identität hinzufügen ",
	...
	"Added new finance account." => "Neues Finanzkonto hinzugefügt.",
	"Added new finance category." => "Neue Finanzkategorie hinzugefügt.",
	...
	"Invalid hash - please recheck the link in your e-mail." => "Ungültiger Hash - bitte überprüfen Sie den Link in Ihrer E-Mail.",
	...
	"No such user account exists." => "Ein solches Benutzerkonto existiert nicht.",
	...
	"Removed password." => "Passwort entfernt.",
	...
	"That account has not requested a password reset." => "Für diesen Account wurde keine Kennwortzurücksetzung angefordert.",
	"That e-mail address is already in use by another account using password login." => "Diese E-Mail-Adresse wird bereits von einem anderen Konto mit Passwort-Login verwendet.",
	...
	"This e-mail address is already being used by another account for password login." => "Diese E-Mail-Adresse wird bereits von einem anderen Konto mit Passwort-Login verwendet.",
	...
	"Updated password." => "Passwort aktualisiert.",
	...
	"You cannot use both OpenID and password at login." => "Sie können OpenID und Passwort nicht gleichzeitig beim Einloggen verwenden.",
	"You cannot use both OpenID and password at signup." => "Sie können OpenID und Passwort nicht gleichzeitig bei Anmeldung verwenden.",
	"You did not select the confirmation checkbox." => "Sie haben nicht das Häkchen in das Kontrolkästchen gesetzt.",
	...
	"You need to have added an e-mail address to your account before you can enable password login." => "Sie müssen eine E-Mail-Adresse zu Ihrem Konto hinzugefügt haben, bevor Sie Passwort-Login verwenden möchten. ",
	...
	"You need to select your e-mail address in order to use password login." => "Sie müssen Ihre E-Mail-Adresse auswählen, um Passwort-Login zu nutzen.",
