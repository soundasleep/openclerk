...
$standard_jobs = array(
	...
	array('table' => 'users', 'type' => 'first_report', 'query' => ' AND is_first_report_sent=0 AND is_disabled=0', 'user_id' => get_site_config('system_user_id'), 'queue_field' => 'last_report_queue'),
