 ...
 */
function insert_new_block_count($job, $currency, $value) {

  $block_table = "blockcount_" . $currency;
  ...
  // we have a balance; update the database
  $q = db()->prepare("INSERT INTO $block_table SET blockcount=:value,is_recent=1");
  $q->execute(array(
    "value" => $value,
  ));
