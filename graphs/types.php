...
function graph_types() {
	...
	$data = array(
		...
		'mtgox_btc_table' => array('title' => 'Mt.Gox USD/BTC (table)', 'heading' => 'Mt.Gox', 'description' => 'A simple table displaying the current buy/sell USD/BTC price on Mt.Gox.', 'default_width' => get_site_config('default_user_graph_height')),
