...
function get_exchange_pairs() {
	return array(
		...
		"cryptsy" => array(array('btc', 'ltc'), array('btc', 'ppc'), array('btc', 'ftc'), array('btc', 'nvc'), array('btc', 'xpm'),
				...
				array('btc', 'vrc'), array('btc', 'nxt'), array('ltc', 'nxt'), array('btc', 'via'),
		),
...
function get_supported_wallets() {
	return array(
		...
		"poloniex" => array('btc', 'ltc', 'dog', 'vtc', 'wdc', 'nmc', 'ppc', 'xpm', 'ixc', 'bc1', 'nxt', 'rdd', 'via'),		// and LOTS more; used in jobs/poloniex.php
