...
page_header(t("Your Hashrates"), "page_your_hashrates", array('js' => array('accounts'), 'class' => 'report_page'));
...
<tfoot>
  <tr>
    ...
    <br>
    <a class="add_accounts" href="<?php echo htmlspecialchars(url_for('wizard_accounts')); ?>"><?php echo t("Add accounts and addresses"); ?></a>
    </li>
    <?php } ?>
  </ul>
</div>
