...
<div class="transaction-introduction">
  ...
  <p>
    ...
    <a href="<?php echo htmlspecialchars(url_for('help/finance')); ?>"><?php echo t("Learn more"); ?></a>
  </p>
...
<p>
  ...
  echo t("Here you may add in a transaction for a different :account or :category that cannot be :generated.",
    array(
      ...
      ':generated' => link_to(url_for('help/transaction_creation'), t("generated automatically")),
    ));
  ?>
</p>
