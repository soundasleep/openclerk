...
<ol class="steps">
	...
	<li>Enter any title you want, select "Enable POST" and click "Confirm".<br>
...
<ul>
	...
	<li>Through the <?php echo $account_data['exchange_name']; ?> interface you can revoke a set of API keys&apos; access at any time by
		...
		Alternatively, you can disable access by clicking the <i>edit</i> button, unselecting the "<i>enable post</i>" and "<i>active</i>" checkboxes and clicking <i>Save</i>.<br>
