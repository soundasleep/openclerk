<?php
$account_data = array('exchange_name' => get_exchange_name('lite_coinpool'));
?>
...
<ol class="steps">
	<li>Log into your <?php echo $account_data['exchange_name']; ?> account
		and visit your <a href="http://lite.coin-pool.com/accountdetails">Account Details page</a>.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/lite_coinpool1.png')); ?>"></li>
	...
	<li>Copy and paste your <i>API Key</i> into the <a class="wizard_link" href="<?php echo htmlspecialchars(url_for('wizard_accounts_pools')); ?>">"Add new Mining Pool" form</a>, and click "Add account".<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/lite_coinpool2.png')); ?>"></li>
</ol>
</div>
