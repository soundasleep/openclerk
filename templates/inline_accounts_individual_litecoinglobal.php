...
<h2>Adding individual Litecoin Global securities</h2>

<ol class="steps">
	<li>As of version 0.10, you can manually add quantities of privately-owned securities
		to your portfolio, and estimate their value against those traded on Litecoin Global,
	...
	<li>For example, if you own 10 shares of S-DICE.PT privately, then you can track these shares
		using the S-DICE.PT value on the public Litecoin Global securities exchange.</li>
</ol>
</div>
