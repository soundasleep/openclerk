...
<div class="feature feature-left" id="home_feature_addresses">
  ...
  <p>
    <a href="<?php echo htmlspecialchars(url_for('help/cryptocurrencies')); ?>"><?php echo ht("What are cryptocurrencies?"); ?></a>
  </p>
</div>
...
<div class="feature feature-right" id="home_feature_accounts">
  ...
  <p>
    <a href="<?php echo htmlspecialchars(url_for('help/notifications')); ?>"><?php echo ht("Configure e-mail notifications"); ?></a> <span class="new"><?php echo ht("new"); ?></span>
  </p>
</div>
