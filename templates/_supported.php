...
<div class="screenshots_group">
<ul class="screenshots">
  <li class="add_service"><a href="<?php echo htmlspecialchars(url_for('help/add_service')); ?>"><?php echo ht("Add another mining pool..."); ?></a></li>
</ul>
</div>
...
<div class="screenshots_group">
<ul class="screenshots">
  <li class="add_service"><a href="<?php echo htmlspecialchars(url_for('help/add_service')); ?>"><?php echo ht("Add another wallet..."); ?></a></li>
</ul>
</div>
...
<ul class="screenshots">
  <li class="historical"><a href="<?php echo htmlspecialchars(url_for('historical')); ?>"><?php echo ht("Historical Data"); ?></a></li>
  <li class="add_service"><a href="<?php echo htmlspecialchars(url_for('help/add_service')); ?>"><?php echo ht("Add another exchange..."); ?></a></li>
</ul>
</div>
...
<div class="screenshots_group">
<ul class="screenshots">
  <li class="add_service"><a href="<?php echo htmlspecialchars(url_for('help/add_currency')); ?>"><?php echo ht("Add another cryptocurrency..."); ?></a></li>
</ul>
</div>
    ...
    <li id="tab_home_updates_tab" style="display:none;">
      ...
      <dl class="version-list">
        ...
        <dd class="last-version-item">
          <a href="<?php echo htmlspecialchars(url_for('help/versions')); ?>">Full version history</a>
        </dd>
