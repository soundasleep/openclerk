...
<a href="<?php echo htmlspecialchars(url_for('help/notifications')); ?>" title="<?php echo ht("How do automatic notifications work?"); ?>"><div class="splash"></div></a>
...
<p>
  ...
  ", array(":notify_you" => link_to(url_for('help/notifications'), ht("notify you")))); ?>
</p>
