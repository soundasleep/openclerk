<?php
$account_data = array('exchange_name' => get_exchange_name('ozcoin_ltc') . " LTC");
?>
...
<ol class="steps">
	<li>Log into your <?php echo $account_data['exchange_name']; ?> account
		and visit your <a href="https://lc.ozcoin.net/content/api-key">API Key page</a>.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/ozcoin_ltc1.png')); ?>"></li>
	...
	<li>Copy and paste your <i>API Key</i> into the <a class="wizard_link" href="<?php echo htmlspecialchars(url_for('wizard_accounts_pools')); ?>">"Add new Mining Pool" form</a>, and click "Add account".<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/ozcoin_ltc2.png')); ?>"></li>
</ol>
</div>
