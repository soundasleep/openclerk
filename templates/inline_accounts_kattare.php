<?php
$account_data = array('exchange_name' => get_exchange_name('kattare'));
?>
...
<ol class="steps">
	<li>Log into your <?php echo $account_data['exchange_name']; ?> account
		and visit the <a href="http://ltc.kattare.com/accountdetails.php">Account Settings page</a>.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/kattare1.png')); ?>"></li>
	...
	<li>Copy and paste your <i>API Key</i> into the <a class="wizard_link" href="<?php echo htmlspecialchars(url_for('wizard_accounts_pools')); ?>">"Add new Mining Pool" form</a>, and click "Add account".<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/kattare2.png')); ?>"></li>
</ol>
</div>
