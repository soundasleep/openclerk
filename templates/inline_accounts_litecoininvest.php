<?php
$account_data = array('exchange_name' => get_exchange_name('litecoininvest'));
?>
...
<ol class="steps">
	<li>Log into your <a href="https://www.litecoininvest.com/account/api"><?php echo $account_data['exchange_name']; ?> account</a> and go to the <i>Private API</i> section of your <i>Account Settings</i>.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/litecoininvest1.png')); ?>"></li>

	<li>Click on the <i>Generate private API key</i> button to generate a new API key.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/litecoininvest2.png')); ?>"></li>
	...
	<li>Copy and paste this new <i>API Key</i> into the <a class="wizard_link" href="<?php echo htmlspecialchars(url_for('wizard_accounts_securities')); ?>">"Add new Securities Exchange" form</a>, and click "Add account".<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/litecoininvest3.png')); ?>"></li>
</ol>
</div>
...
<ul>
	...
	<li>Through the <?php echo $account_data['exchange_name']; ?> interface you can revoke an API key&apos;s access at any time, by
		revisiting your <a href="https://www.litecoininvest.com/account/api">Private API page</a> and clicking on the <i>Generate new private API key</i> or <i>Revoke private API key</i> buttons.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/litecoininvest_delete.png')); ?>"></li>
