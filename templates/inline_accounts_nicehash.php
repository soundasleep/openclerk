<?php
$account_data = array('exchange_name' => get_exchange_name('nicehash'));
?>
...
<ol class="steps">
	<li>Log into your <?php echo $account_data['exchange_name']; ?> account
		and visit your <a href="https://www.nicehash.com/index.jsp?p=account">Account page</a>.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/nicehash1.png')); ?>"></li>
	...
	<li>Copy and paste your <i>API ID</i> and <i>ReadOnly API Key</i> into the <a class="wizard_link" href="<?php echo htmlspecialchars(url_for('wizard_accounts_pools')); ?>">"Add new Mining Pool" form</a>, and click "Add account".<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/nicehash2.png')); ?>"></li>
</ol>
</div>
...
<ul>
	...
	<li>Through the <?php echo $account_data['exchange_name']; ?> interface you can generate new API keys by
		visiting your <a href="https://www.nicehash.com/index.jsp?p=account">Account page</a> and clicking <i>Get new key</i>.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/nicehash_delete.png')); ?>"></li>
</ul>
</div>
