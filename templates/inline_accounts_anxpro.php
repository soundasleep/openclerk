<?php
$account_data = array('exchange_name' => get_exchange_name('anxpro'));
?>
...
<ol class="steps">
	<li>Log into your <a href="https://anxpro.com/#settings/"><?php echo $account_data['exchange_name']; ?> account</a>
		and visit your Account Profile.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/anxpro1.png')); ?>"></li>

	<li>Under the "API" tab, click "Create" to create a new API key.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/anxpro2.png')); ?>"></li>

	<li>Click "Reset Secret" to reset and display the secret for this API key.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/anxpro3.png')); ?>"></li>
	...
	<li>Copy and paste the <i>API Key</i> and <i>API Secret</i> into the <a class="wizard_link" href="<?php echo htmlspecialchars(url_for('wizard_accounts_exchanges')); ?>">"Add new Exchange" form</a>, and click "Add account".<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/anxpro4.png')); ?>"></li>
</ol>
</div>
...
<ul>
	...
	<li>Through the <?php echo $account_data['exchange_name']; ?> interface you can deactivate or delete an API key at any time by clicking <i>Deactivate</i> or <i>Delete</i>.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/anxpro_delete.png')); ?>"></li>
