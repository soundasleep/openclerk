<?php
$account_data = array('exchange_name' => get_exchange_name('d2_wdc') . " WDC");
?>
...
<ol class="steps">
	<li>Log into your <a href="https://wdc.d2.cc/accountdetails.php"><?php echo $account_data['exchange_name']; ?> account details</a>.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/d2_wdc1.png')); ?>"></li>

	<li>Find your <i>API Key</i>, as illustrated below: <br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/d2_wdc2.png')); ?>"></li>
