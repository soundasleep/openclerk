...
<ol class="steps">
	<li>Log into your <a href="http://ftc.mining-foreman.org/accountdetails">Mining Foreman FTC account details</a>.<br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/miningforeman_ftc1.png')); ?>"></li>

	<li>Find your <i>API Key</i>, as illustrated below: <br>
		<img src="<?php echo htmlspecialchars(url_for('img/accounts/miningforeman_ftc2.png')); ?>"></li>
